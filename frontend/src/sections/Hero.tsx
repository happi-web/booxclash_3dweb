  ...
  return (
    ...
    <Navbar />
        <div className="w-full h-138 mx-auto flex flex-col c-space gap-3 z-10   bg-black/70">
            ...
            <button onClick={() => navigate('/app')} className="sm:text-2xl text-xl hover:text-white cursor-pointer font-medium z-10 text-black mt-8  bg-yellow-200 hover:bg-purple-950 text-center mx-auto p-2 w-30 rounded font-generalsans">
                PLAY
            </button>
        </div>
